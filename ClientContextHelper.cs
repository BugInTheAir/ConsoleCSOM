...
namespace ConsoleCSOM
{
    public class ClientContextHelper : IDisposable
    {
        ...
        private const string defaultAADAppId = "465e8191-088a-464d-ab1f-f9d31fb8b8b3";
        ...
        private async Task<string> AcquireTokenAsync(Uri resourceUri, string username, string password)
        {
            ...
            var body = $"resource={resource}&client_secret={HttpUtility.UrlEncode("TI~7Q~zM51FbV18GDFPUvs.-iuRmuv4J5Yplx")}&client_id={clientId}&grant_type=password&username={HttpUtility.UrlEncode(username)}&password={HttpUtility.UrlEncode(password)}";
